    ...
    <div className="relative flex w-fit items-center rounded-full">
      ...
      >
        <motion.span
          ...
          className="h-full w-1/2 shadow-md shadow-red-950/30 rounded-full bg-[linear-gradient(to_right,theme(colors.red.300),theme(colors.pallet-blue.1),theme(colors.pallet-blue.2),theme(colors.pallet-pink.2),theme(colors.red.200),theme(colors.pallet-blue.2),theme(colors.pallet-blue.1))] bg-[length:200%_auto] animate-gradient"
        />
      </div>
    </div>
  );
